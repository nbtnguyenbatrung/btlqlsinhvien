...
{
    public partial class Frm_discipline : Form
    {
        #region Fields
        ...
        public Frm_discipline()
        {
            InitializeComponent();
            dataservice.OpenConnection();
        }

        private void Frm_discipline_Load(object sender, EventArgs e)
        {
            m_khoaCtrl.HienThiComboBox(cbxkhoa);
            m_sinhvienCtrl.HienThiDsHocVienall(lvchuaphan);
            dptngaycap.Value = DateTime.Today;
        }
        ...
        private void btnchuyen_Click(object sender, EventArgs e)
        {
            ...
            while (ie.MoveNext())
            {
                ...
                foreach (ListViewItem item in lvphan.Items)
                {
                    ...
                    {
                        MessageBoxEx.Show("Sinh viên " + item.SubItems[1].Text + " hiện đang bị kỷ luật ", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        state = true;
                        goto Cont;
                    }
                }
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            {
                m_sinhvienCtrl.LuuHVVaoBangkyluat(lvphan, dptngaycap.Value);
                lvphan.Items.Clear();
