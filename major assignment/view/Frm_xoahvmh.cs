...
{
    public partial class Frm_xoahvmh : Form
    {
        ...
        private void Frm_xoahvmh_Load(object sender, EventArgs e)
        {
        ...
        private void cmbmadiem_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cmbmh.SelectedValue != null && 
                !cmbmadiem.SelectedValue.ToString().Equals("System.Data.DataRowView"))
            {
                m_Command = m_Connection.CreateCommand();
        ...
        {
            m_Command.CommandText = "delete from tb_student_subject where ID =" + cmbmadiem.SelectedValue;
            m_Command.ExecuteNonQuery();
