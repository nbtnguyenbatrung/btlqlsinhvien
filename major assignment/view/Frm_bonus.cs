...
{
    public partial class Frm_bonus : Form
    {
        #region Fields
        ...
        private void btnchuyen_Click(object sender, EventArgs e)
        {
            ...
            while (ie.MoveNext())
            {
                ...
                foreach (ListViewItem item in lvphan.Items)
                {
                    ...
                    {
                        MessageBoxEx.Show("Sinh viên " + item.SubItems[1].Text + " hiện đang được khen thưởng ", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        state = true;
                        goto Cont;
                    }
                }
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            {
                m_sinhvienCtrl.LuuHVVaoBangkhenthuong(lvphan, dptngaycap.Value);
                lvphan.Items.Clear();
